...
export default function CreateHba1cModal(props) {
    ...
    const createHba1c = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${serverDomain}/blood/hba1c`, info, {withCredentials : true, headers : {Authorization : token}});
