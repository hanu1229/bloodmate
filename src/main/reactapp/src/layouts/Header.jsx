...
export default function Header(props) {
    ...
    const logoutButtonClick = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${serverDomain}/user/logout`, null, { headers : { Authorization : token, "Content-Type" : "application/json" }});
        } catch(e) {
            console.log(e);
        }
        alert("로그아웃 되었습니다.");
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <Button 
                            ...
                            onClick={() => {props.loginState ? logoutButtonClick() : loginButtonClick()}}
                        >
                            {props.loginState ? "로그아웃" : "로그인"}
                        </Button>
                    </li>
                </ul>
            </div>
